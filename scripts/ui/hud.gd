...
func _crear_label_inventario() -> void:
	_inventario = Label.new()
	_inventario.name = "Inventario"
	_inventario.anchor_left = 1.0
	_inventario.anchor_right = 1.0
	_inventario.anchor_top = 1.0
	_inventario.anchor_bottom = 1.0
	_inventario.offset_left = -280.0
	_inventario.offset_top = -48.0
	_inventario.offset_right = -20.0
	_inventario.offset_bottom = -16.0
	_inventario.horizontal_alignment = HORIZONTAL_ALIGNMENT_RIGHT
	_inventario.add_theme_font_size_override("font_size", 18)
